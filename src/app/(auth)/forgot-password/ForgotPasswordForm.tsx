  ...
  if (sent) {
    return (
      <div style={{ padding: '24px', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 8, textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 14, fontWeight: 600, color: '#15803d', marginBottom: 6 }}>Check your email</div>
    ...
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <div>
        ...
        <div style={{ position: 'relative' }}>
          <Mail size={14} color="var(--ink-4)" style={{ position: 'absolute', left: 10, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
          <input
            type="email"
